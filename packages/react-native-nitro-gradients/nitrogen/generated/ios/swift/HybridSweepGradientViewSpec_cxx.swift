...
open class HybridSweepGradientViewSpec_cxx {
  ...
  // Methods
  @inline(__always)
  public final func update(colors: bridge.std__vector_double_, positions: bridge.std__optional_std__vector_double__, center: bridge.std__optional_Vector_, blur: bridge.std__optional_double_, tileMode: bridge.std__optional_std__string_) -> bridge.Result_void_ {
    do {
