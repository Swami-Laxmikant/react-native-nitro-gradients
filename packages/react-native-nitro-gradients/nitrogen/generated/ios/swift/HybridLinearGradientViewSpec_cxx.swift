...
open class HybridLinearGradientViewSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridLinearGradientViewSpec_cxx) -> Bool {
  ...
  public final var start: bridge.std__optional_Vector_ {
    ...
    @inline(__always)
    set {
      self.__implementation.start = newValue.value
    }
  }
  ...
  public final var angle: bridge.std__optional_double_ {
    ...
    @inline(__always)
    set {
      self.__implementation.angle = { () -> Double? in
  ...
  // Methods
  @inline(__always)
  public final func update(colors: bridge.std__vector_double_, positions: bridge.std__optional_std__vector_double__, start: bridge.std__optional_Vector_, end: bridge.std__optional_Vector_, angle: bridge.std__optional_double_, blur: bridge.std__optional_double_, tileMode: bridge.std__optional_std__string_) -> bridge.Result_void_ {
    do {
      ...
      }(), start: start.value, end: end.value, angle: { () -> Double? in
        if bridge.has_value_std__optional_double_(angle) {
          let __unwrapped = bridge.get_std__optional_double_(angle)
          return __unwrapped
        } else {
          return nil
        }
