///
/// HybridRadialGradientViewManager.kt
...
public class HybridRadialGradientViewManager: SimpleViewManager<View>() {
  ...
  override fun createViewInstance(reactContext: ThemedReactContext): View {
    val hybridView = HybridRadialGradientView(reactContext)
  ...
  override fun updateState(view: View, props: ReactStylesDiffMap, stateWrapper: StateWrapper): Any? {
    ...
    HybridRadialGradientViewStateUpdater.updateViewProps(hybridView, stateWrapper)
  ...
  private fun getHybridView(view: View): HybridRadialGradientView? {
    return view.getTag(associated_hybrid_view_tag) as? HybridRadialGradientView
  }
}
