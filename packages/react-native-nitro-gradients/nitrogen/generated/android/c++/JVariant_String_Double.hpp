...
namespace margelo::nitro::gradient {
  ...
  public:
    static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/gradient/Variant_String_Double;";
  ...
  namespace JVariant_String_Double_impl {
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/gradient/Variant_String_Double$First;";
    ...
    public:
      static constexpr auto kJavaDescriptor = "Lcom/margelo/nitro/gradient/Variant_String_Double$Second;";
