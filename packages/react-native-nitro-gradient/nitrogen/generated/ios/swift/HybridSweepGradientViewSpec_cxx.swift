...
open class HybridSweepGradientViewSpec_cxx {
  ...
  // Methods
  @inline(__always)
  public final func update(colors: bridge.std__optional_std__vector_double__, positions: bridge.std__optional_std__vector_double__, center: bridge.std__optional_VectorR_, startAngle: bridge.std__optional_double_, endAngle: bridge.std__optional_double_) -> bridge.Result_void_ {
    do {
