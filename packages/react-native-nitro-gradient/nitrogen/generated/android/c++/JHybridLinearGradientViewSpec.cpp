...
namespace margelo::nitro::gradient {
  ...
  // Methods
  void JHybridLinearGradientViewSpec::update(const std::optional<std::vector<double>>& colors, const std::optional<std::vector<double>>& positions, const std::optional<VectorR>& start, const std::optional<VectorR>& end) {
    static const auto method = javaClassStatic()->getMethod<void(jni::alias_ref<jni::JArrayDouble> /* colors */, jni::alias_ref<jni::JArrayDouble> /* positions */, jni::alias_ref<JVectorR> /* start */, jni::alias_ref<JVectorR> /* end */)>("update");
