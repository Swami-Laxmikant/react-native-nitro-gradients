...
namespace margelo::nitro::gradient {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/gradient/Variant_String_Double;";
  ...
  namespace JVariant_String_Double_impl {
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/gradient/Variant_String_Double$First;";
    ...
    public:
      static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/gradient/Variant_String_Double$Second;";
